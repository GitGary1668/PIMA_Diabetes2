...
model_path = hf_hub_download(repo_id="GaryWilliams1668/HFSpaceName-PIMA-Diabetes2", filename="best_pima_diabetes_model_v1.joblib")                                       # enter the Hugging Face username here
